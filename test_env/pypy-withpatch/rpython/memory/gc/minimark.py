...
class MiniMarkGC(MovingGCBase):
    ...
    def setup(self):
        ...
        self.visited_objs = self.AddressDict()
        #
    ...
    def obj_visited(self, obj):
        return self.visited_objs.contains(obj) and self.visited_objs.get(obj) == obj

    def mark_obj_visited(self, obj):
        self.visited_objs.setitem(obj, obj)

    def unmark_obj_visited(self, obj):
        self.visited_objs.setitem(obj, llmemory.NULL)
    ...
    def debug_check_object(self, obj):
        ...
        ll_assert(not self.obj_visited(obj),
    ...
    def _visit_young_rawmalloced_object(self, obj):
        ...
        hdr = self.header(obj)
        if self.obj_visited(obj):
            #if hdr.tid & GCFLAG_VISITED:
            return
        self.mark_obj_visited(obj)
    ...
    def visit(self, obj):
        ...
        # collection.
        hdr = self.header(obj)
        if self.obj_visited(obj) or hdr.tid & GCFLAG_NO_HEAP_PTRS:
            return
    ...
    def invalidate_young_weakrefs(self):
        ...
        while self.young_objects_with_weakrefs.non_empty():
            ...
            #
                ...
                if self.obj_visited(pointing_to):
